...
import { View, Text, Image, KeyboardAvoidingView, ScrollView, Platform, Pressable } from "react-native";
        ...
        <SafeAreaView className="w-full h-full bg-primary px-7 justify-center">
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
                ...
                <View className="my-10">
                    ...
                    <Text className="text-white text-2xl font-psemibold mt-10">Register</Text>
                </View>
